// CodePen packages: @radix-ui/react-slot@^1.2.4, class-variance-authority@^0.7.1, clsx@^2.1.1, lucide-react@^0.562.0, motion@^12.23.26, react-dom@19.2.3, react@19.2.3, tailwind-merge@^3.4.0
...
import React, { forwardRef, type ButtonHTMLAttributes, useEffect, useRef, useState } from "react";
...
const Header = ({ id, className }: Props) => {
  return (
