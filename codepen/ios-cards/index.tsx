// CodePen packages: lucide-react@^0.562.0, motion@^12.23.26, react-dom@19.2.3, react@19.2.3
...
function Item({ id, setSelectedId }: ItemProps) {
...
const List = ({ setSelectedId }: Props) => {
  return (
