...
const Validation = ({ children, className, variant }) => {
  return /* @__PURE__ */ React.createElement("div", { className: cn(validationVariants({ variant, className })) }, children, variant === "error" && /* @__PURE__ */ React.createElement(TriangleAlertIcon, { className: "ml-1 size-4" }), variant === "success" && /* @__PURE__ */ React.createElement(CheckIcon, { className: "ml-1 size-4" }), variant === "warning" && /* @__PURE__ */ React.createElement(TriangleAlertIcon, { className: "ml-1 size-4" }), variant === "loading" && /* @__PURE__ */ React.createElement("span", { className: "ml-1" }, /* @__PURE__ */ React.createElement(Spinner, { size: 16 })));
};
const FormControl = ({
  label,
  labelRight,
  ...
  return /* @__PURE__ */ React.createElement("div", { className: cn("mb-4 flex flex-col", className) }, (label || labelRight) && /* @__PURE__ */ React.createElement("div", { className: "mb-2 flex items-center justify-between gap-1" }, /* @__PURE__ */ React.createElement("div", null, label && /* @__PURE__ */ React.createElement(
    Label,
    {
    ...
    label
  )), /* @__PURE__ */ React.createElement("div", null, labelRight)), children, caption && /* @__PURE__ */ React.createElement(
    "span",
    {
      className: cn("mt-1 text-muted-foreground text-sm", captionClassName)
    },
    caption
  ), controlLeft && /* @__PURE__ */ React.createElement("div", { className: "mt-1" }, controlLeft), /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    success && /* @__PURE__ */ React.createElement(Validation, { className: validationClassName, variant: "success" }, success),
    warning && /* @__PURE__ */ React.createElement(Validation, { className: validationClassName, variant: "warning" }, warning),
    error && /* @__PURE__ */ React.createElement(Validation, { className: validationClassName, variant: "error" }, error),
    loading && /* @__PURE__ */ React.createElement(Validation, { className: validationClassName, variant: "loading" }, loading)
  ));
};
...
const CardBlock = ({ item, index = 0 }) => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true });
  useEffect(() => {
    console.log("Element is in view: ", isInView);
  }, [isInView]);
  const inputClassName = "bg-page-input-background text-page-input-text rounded-page-widget-block border-page-input-border shadow-page-input placeholder:text-page-input-placeholder! h-12! text-base";
  return /* @__PURE__ */ React.createElement(
    motion.div,
    {
      animate: isInView ? {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "size-full rounded-page-widget border-page-widget bg-page-widget-background p-4 text-page-body-text shadow-page-widget backdrop-blur-page-widget" }, /* @__PURE__ */ React.createElement("div", { className: "mb-1 shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "page-heading line-clamp-2 grow text-left text-lg" }, "This is the title ", item.id)), /* @__PURE__ */ React.createElement("div", { className: "line-clamp-2 shrink-0 text-left" }, "This is a description of the content."), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "mb-2" }, /* @__PURE__ */ React.createElement(Label, { className: "cursor-pointer", htmlFor: "email" }, "Email")), /* @__PURE__ */ React.createElement(FormControl, { name: "email" }, /* @__PURE__ */ React.createElement(
      Input,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Button, { size: "block", variant: "blockPrimary" }, "Primary"), /* @__PURE__ */ React.createElement(Button, { size: "block", variant: "blockSecondary" }, "Secondary"))))
  );
};
function App() {
  return /* @__PURE__ */ React.createElement(CardBlock, null);
}
