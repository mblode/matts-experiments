// CodePen packages: @beautiful-qr-code/react@^1.0.7, @radix-ui/react-label@^2.1.8, class-variance-authority@^0.7.1, clsx@^2.1.1, culori@^4.0.2, lucide-react@^0.562.0, react-dom@19.2.3, react@19.2.3, tailwind-merge@^3.4.0
