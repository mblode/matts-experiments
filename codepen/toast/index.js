...
import { createContext, forwardRef, useLayoutEffect, useRef, useState } from "react";
...
const ToastLoadingContext = createContext({
  state: "idle",
  setState: () => void 0
});
function PendingView() {
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-[48px] items-center justify-center gap-2.5 rounded-full bg-[#E5F3FF] px-5" }, /* @__PURE__ */ React.createElement("div", { className: "inline-flex h-5 w-5 flex-shrink-0 items-center justify-center" }, /* @__PURE__ */ React.createElement(
    "svg",
    {
  ...
  )), /* @__PURE__ */ React.createElement("span", { className: "whitespace-nowrap font-semibold text-[#4EAFFF] text-base" }, "Loading..."));
}
function ErrorView() {
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-[48px] items-center justify-center gap-2.5 rounded-full bg-[#FFE4E3] px-5" }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
      animate: {
        x: [0, -3, 2.5, -2, 1.5, -1, 0]
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("title", null, "Error"),
      /* @__PURE__ */ React.createElement(
        "path",
        {
          clipRule: "evenodd",
  ...
  ), /* @__PURE__ */ React.createElement("span", { className: "whitespace-nowrap font-semibold text-[#FF403F] text-base" }, "Error occurred"));
}
function SuccessView() {
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-[48px] items-center justify-center gap-2.5 rounded-full bg-[#DBF4DE] px-5" }, /* @__PURE__ */ React.createElement("div", { className: "inline-flex h-5 w-5 flex-shrink-0 items-center justify-center" }, /* @__PURE__ */ React.createElement(
    "svg",
    {
      fill: "none",
      height: "24",
  ...
  )), /* @__PURE__ */ React.createElement("span", { className: "whitespace-nowrap font-semibold text-[#35C759] text-base" }, "Success!"));
}
...
const ToastLoading = () => {
  ...
  function renderContent() {
    switch (state) {
      case "error":
        return /* @__PURE__ */ React.createElement(ErrorView, null);
      case "success":
        return /* @__PURE__ */ React.createElement(SuccessView, null);
      default:
        return /* @__PURE__ */ React.createElement(PendingView, null);
    }
  }
  useLayoutEffect(() => {
  ...
  return /* @__PURE__ */ React.createElement(ToastLoadingContext.Provider, { value: { state, setState } }, /* @__PURE__ */ React.createElement("div", { className: "flex h-[400px] w-full items-center justify-center border border-border bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center gap-8" }, /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "pointer-events-none absolute top-0 left-1/2 flex h-[200px] w-[300px] -translate-x-1/2 items-start justify-center" }, /* @__PURE__ */ React.createElement(AnimatePresence, { custom: transition, mode: "popLayout" }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
      exit: "exit",
      initial: { opacity: 0 },
    ...
    renderContent()
  )))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Button, { onClick: () => handleStateChange("pending") }, "Pending"), /* @__PURE__ */ React.createElement(Button, { onClick: () => handleStateChange("error") }, "Error"), /* @__PURE__ */ React.createElement(Button, { onClick: () => handleStateChange("success") }, "Success")))));
};
const ToastBlock = () => {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(ToastLoading, null));
};
function App() {
  return /* @__PURE__ */ React.createElement(ToastBlock, null);
}
